...
w_dir = 'step1'
rq_name = 'darkHiggs_'+mp+'_step1_'+sgn
...
cmd_str = 'dasgoclient -query="dataset=/monoHiggsMC_darkHiggs_semiLep*/*'+mp+'*step0_newLHE*'+sgn+'*/USER instance=prod/phys03" --format=json'
...
config.Data.outputDatasetTag = 'EXO-RunIIFall17wmLHEGS-darkHiggs_theta_0p01_gq_0p25_gx_1p0_'+mp+'_step1_'+sgn
