...
cmd_str = 'dasgoclient -query="dataset=/monoHiggsMC_darkHiggs_semiLep*/*'+mp+'*step0_Wjjlnu*/USER instance=prod/phys03" --format=json'
...
config.JobType.psetName    = 'step1_all.py'
config.JobType.pyCfgParams = [mp]
#config.JobType.maxMemoryMB = 10000
config.JobType.maxMemoryMB = 5000
#config.JobType.numCores    = 5
...
config.Data.outputDatasetTag = 'EXO-RunIIFall17wmLHEGS-darkHiggs_theta_0p01_gq_0p25_gx_1p0_'+mp+'_step1_Wjjlnu'
