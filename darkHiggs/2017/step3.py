...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:EXO-RunIIFall17wmLHEGS-darkHiggs_theta_0p01_gq_0p25_gx_1p0_'+sys.argv[-2]+'_step2_'+sys.argv[-1]+'.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIIFall17MiniAODv2-00071.root'),
