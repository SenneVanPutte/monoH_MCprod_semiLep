...
cmd_str = 'dasgoclient -query="dataset=/monoHiggsMC_darkHiggs_semiLep*/*'+mp+'*step3*'+sgn+'*/USER instance=prod/phys03" --format=json'
out_cmd = os.popen(cmd_str).read()
...
config.Data.outputDatasetTag = 'EXO-RunIIFall17wmLHEGS-darkHiggs_theta_0p01_gq_0p25_gx_1p0_'+mp+'_NANOv4_'+sgn
