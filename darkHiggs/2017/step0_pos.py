...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #fileName = cms.untracked.string('file:2HDMa_gg_sinp_0p35_tanb_1p0_mXd_10_'+sys.argv[-1]+'_pos.root'),
    fileName = cms.untracked.string('file:darkHiggs_theta_0p01_gq_0p25_gx_1p0_'+sys.argv[-1]+'_WW_pos.root'),
