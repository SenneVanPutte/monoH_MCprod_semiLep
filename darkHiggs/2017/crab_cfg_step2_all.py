...
cmd_str = 'dasgoclient -query="dataset=/monoHiggsMC_darkHiggs_semiLep*/*'+mp+'*step1*Wjjlnu*/USER instance=prod/phys03" --format=json'
...
config.JobType.psetName    = 'step2_all.py'
...
config.Data.outputDatasetTag = 'EXO-RunIIFall17wmLHEGS-darkHiggs_theta_0p01_gq_0p25_gx_1p0_'+mp+'_step2_Wjjlnu'
