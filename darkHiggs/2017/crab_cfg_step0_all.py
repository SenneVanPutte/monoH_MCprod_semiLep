...
config.JobType.psetName    = 'step0_all.py'
...
config.JobType.inputFiles = ['/afs/cern.ch/user/s/svanputt/work/monoHiggs/MCprod/CMSSW_9_4_9/src/monoH_MC_production_2017/darkHiggs/2017/LHE/new/darkHiggs_theta_0p01_gq_0p25_gx_1p0_'+mp+'_WW.lhe']
...
config.Data.outputDatasetTag = 'EXO-RunIIFall17wmLHEGS-darkHiggs_theta_0p01_gq_0p25_gx_1p0_'+mp+'_step0_Wjjlnu'
