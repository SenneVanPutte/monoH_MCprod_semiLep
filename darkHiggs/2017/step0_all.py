...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:darkHiggs_theta_0p01_gq_0p25_gx_1p0_'+sys.argv[-1]+'_WW_neg.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
        ...
        processParameters = cms.vstring(
            ...
            '24:onIfMatch = 11 13 15 12 14 16 1 2 3 4 5',
            #'24:onNegIfAny = 11 13 15 12 14 16',  # turn ON W- -> lnu
            #'24:onPosIfAny = 1 2 3 4 5',   # turn ON W+ -> qq
            ...
            'ResonanceDecayFilter:daughters = 1, 11',
            ),
