...
if __name__ == '__main__':
    ...
    for sgn in sign:
        ...
        for mass_point in mc_sets:
            ...
            config.General.workArea = 'step1'
            config.General.requestName  = '2HDMa_'+mass_point+'_step1_'+sgn
...
#config.JobType.maxMemoryMB = 10000
            ...
            config.Data.outputDatasetTag = 'EXO-RunIIFall17wmLHEGS-2HDMa_gg_sinp_0p35_tanb_1p0_mXd_10_'+mass_point+'_step1_'+sgn
            ...
            config.Data.inputDataset = 'monoHiggsMC_2HDMa_gg_semiLep/*EXO-RunIIFall17wmLHEGS-2HDMa_gg_sinp_0p35_tanb_1p0_mXd_10_'+mass_point+'_step0_'+sgn+'*/USER'
